...
public class QPIntSolver {
	...
	//cplex variable
	IloCplex cplex;
	private IloIntVar[] X_e; // variable for each edge
	private IloIntVar[] Y_v; // variable for each vertex
	
	public QPIntSolver(Graph g) {
		this.g = g;
		//lambda = 100; // default;
		/**
